# VIT_model.py
"""
ViT model chuẩn rwightman / timm, có thể load pretrained ImageNet-1k / ImageNet-21k
Sử dụng trực tiếp với train.py / test.py
"""
...
import timm  # để load pretrained weights chuẩn nhanh chóng
